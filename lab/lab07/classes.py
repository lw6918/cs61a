...
class AICard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        opponent_card.attack -= opponent_card.defense if opponent_card.attack>opponent_card.defense else opponent_card.attack
...
class TACard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        attack_tmp = opponent_card.attack
        opponent_card.attack = opponent_card.defense
        opponent_card.defense = attack_tmp
...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        opponent_deck_cards = opponent.deck.cards[:]
