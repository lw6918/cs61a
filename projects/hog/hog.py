...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    #         score = score1
    #         opponent = score0
    #     score += take_turn(strategy(score,opponent), opponent,dice,goal)
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    picky_num = picky_piggy_strategy(score,opponent_score,cutoff,num_rolls)
    if picky_num == 0:
        return 0
    picky_score = picky_piggy(opponent_score)
    hogpile_score = hog_pile(score+picky_score, opponent_score)
    if (score+picky_score) == opponent_score:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
