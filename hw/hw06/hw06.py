...
class VirFib():
    ...
    def next(self):
        ...
        if self.value == 0:
            ...
            result = VirFib(self.previous + self.value)
...
def is_bst(t):
    ...
    if len(t.branches) == 1:
        return is_bst(left_child) and (t.label >= bst_max(left_child) or t.label < bst_min(left_child))
    ...
    # https://github.com/y1cunhui/cs61A-2021Fall/blob/main/hw06/hw06.py
    # if t.is_leaf():
    #     return True
    # if len(t.branches) > 2:
    #     return False
