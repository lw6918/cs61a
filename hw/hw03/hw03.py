...
def pingpong(n):
    ...
    # elif n==2:
    #     return 2
    # n1,n2=pingpong(n-1),pingpong(n-2)
    ...
    def helper(n1,n2,i):    # n1,n2=pingpong(i-1),pingpong(i-2)
        if i==n:
            if (i-1)%8==0 or num_eights(i-1)>0:
                ...
                return n1+n1-n2
        if (i-1)%8==0 or num_eights(i-1)>0:
            return helper(n2, n1, i+1)
        else:
            return helper(n1+n1-n2, n1, i+1)
...
def missing_digits(n):
    ...
    if n<10:
        ...
        return missing_digits(n//10)+n%10-n//10%10-1    #max(n%10-n//10%10-1,0)
...
def count_coins(change):
    ...
    def helper(coin,change):
        if change==0:
            ...
            return helper(coin, change-coin)+helper(descending_coin(coin),change)
